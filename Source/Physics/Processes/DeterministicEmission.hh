#ifndef DeterministicEmission_HH
#define DeterministicEmission_HH
...
class DeterministicEmission: public Process
{
public:
    DeterministicEmission(EMField* field, double dt, bool track = false,
        bool classical = false, double eMin = 0);
    
   virtual ~DeterministicEmission();
